...
const SchoolSettings = () => {
  ...
  const userEmail = sessionStorage.getItem('schoolEmail'); // This will be "mlm@gmail.com" if stored in sessionStorage
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post('https://codtsmartschool.strangeweb.in/schoolapi/updatepass.php', data);
