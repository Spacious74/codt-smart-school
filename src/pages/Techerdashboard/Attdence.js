...
import { Box, TextField, Button, Typography, Container, Radio, RadioGroup, FormControlLabel, FormControl, Grid } from '@mui/material';
import Studattendata from './Studattendata';

const AttendanceForm = () => {
    const [uid, setUid] = useState('');
    const [attendance, setAttendance] = useState('');  // To store "present" or "absent"
