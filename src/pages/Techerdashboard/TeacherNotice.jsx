...
import { Grid, Card, CardContent, TextField, Button, Divider, Box, Typography,
...
const TeacherNotice = () => {
  ...
  const fetchNoticesAsync = async () => {
    ...
    const query = `SELECT * FROM notices WHERE school_code = '${schoolCode}' and notification_for='teacher' or school_code='N/A'`;
